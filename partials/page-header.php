...
<header class="<?php echo esc_attr( $classes ); ?>">
	...
	<div class="container clr page-header-inner">
		...
		if ( kaspweb_has_page_header_heading() ) { ?>
			...
			<<?php echo esc_attr( $heading ); ?> class="page-header-title clr"<?php kaspwebwp_schema_markup( 'headline' ); ?>><?php echo wp_kses_post( kaspweb_title() ); ?></<?php echo esc_attr( $heading ); ?>>
