...
<header class="<?php echo esc_attr( $classes ); ?>">
    ...
    <div class="container clr page-header-inner">
        ...
        <?php
        // Return if page header is disabled
        if ( kaspweb_has_page_header_heading() ) { ?>

           <<?php echo esc_attr( $heading ); ?> class="page-header-title clr"<?php kaspwebwp_schema_markup( 'headline' ); ?>><?php echo wp_kses_post( kaspweb_title() ); ?></<?php echo esc_attr( $heading ); ?>><span class="udub-slant"><span></span></span>
     
            <?php get_template_part( 'partials/page-header-subheading' ); ?>

            <?php } ?>

            <?php if ( function_exists( 'kaspweb_breadcrumb_trail' ) ) {
                kaspweb_breadcrumb_trail();
            } ?>

            </div><!-- .page-header-inner -->

        <?php kaspweb_page_header_overlay(); ?>
