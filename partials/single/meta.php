...
<ul class="meta clr">
	...
	foreach ( $sections as $section ) { ?>
		...
		<?php if ( 'author' == $section ) { ?>
			<li class="meta-author"<?php ladysmockwp_schema_markup( 'author_name' ); ?>><i class="icon-user"></i><?php echo the_author_posts_link(); ?></li>
		<?php } ?>

		<?php if ( 'date' == $section ) { ?>
            <li class="meta-date"<?php ladysmockwp_schema_markup( 'publish_date' ); ?>><i class="icon-clock"></i><?php echo get_the_date(); ?></li>
		<?php } ?>
