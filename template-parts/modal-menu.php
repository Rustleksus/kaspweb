	...
	<div class="menu-modal-inner modal-inner">
		...
		<div class="menu-wrapper section-inner">
			...
			<div class="menu-top">
                ...
                <button class="toggle close-nav-toggle fill-children-current-color" data-toggle-target=".menu-modal" data-toggle-body-class="showing-menu-modal" aria-expanded="false" data-set-focus=".menu-modal" style="justify-content:space-between !important; padding: 2rem 0 !important;">
                    <?php
                    // Site title or logo.
                    twentytwenty_site_logo();
                    ?>
					<span class="toggle-text"><?php _e( '', 'twentytwenty' ); ?></span>
					<?php kaspweb_the_theme_svg( 'cross' ); ?>
				</button><!-- .nav-toggle -->
