<?php
/**
 * Customizer Control: kaspweb-dimensions.
 *
 ...
 * Buttonset control
 */
class Kaspweb_Customizer_Dimensions_Control extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'kaspweb-dimensions';
	...
	public function enqueue() {
		wp_enqueue_script( 'kaspweb-dimensions', KASPWEB_INC_DIR_URI . 'customizer/controls/dimensions/dimensions.js', array( 'jquery', 'customize-base' ), false, true );
		wp_localize_script( 'kaspweb-dimensions', 'kaspwebL10n', $this->l10n() );
		wp_enqueue_style( 'kaspweb-dimensions', KASPWEB_INC_DIR_URI . 'customizer/controls/dimensions/dimensions.css', null );
	}
